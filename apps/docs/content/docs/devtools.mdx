---
title: 'Devtools'
description: 'inspectModules() for static snapshots; @katajs/devtools for the live UI.'
---
...
![Kata devtools — live module graph with consumer/producer awareness](/devtools.jpeg)
